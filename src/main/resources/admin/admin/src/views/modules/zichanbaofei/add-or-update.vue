<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'" label="报废编号" prop="baofeibianhao">
					<el-input v-model="ruleForm.baofeibianhao" placeholder="报废编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.baofeibianhao" label="报废编号" prop="baofeibianhao">
					<el-input v-model="ruleForm.baofeibianhao" placeholder="报废编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="报废时间" prop="baofeishijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.baofeishijian" 
						type="date"
						:readonly="ro.baofeishijian"
						placeholder="报废时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.baofeishijian" label="报废时间" prop="baofeishijian">
					<el-input v-model="ruleForm.baofeishijian" placeholder="报废时间" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.baofeishijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='baofeibianhao'){
							this.ruleForm.baofeibianhao = obj[o];
							this.ro.baofeibianhao = true;
							continue;
						}
						...
						if(o=='baofeishijian'){
							this.ruleForm.baofeishijian = obj[o];
							this.ro.baofeishijian = true;
							continue;
						}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zichanbaofei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zichanbaofeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
