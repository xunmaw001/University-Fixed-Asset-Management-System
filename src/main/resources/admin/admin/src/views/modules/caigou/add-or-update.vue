<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="采购账号" prop="caigouzhanghao">
					<el-input v-model="ruleForm.caigouzhanghao" placeholder="采购账号" clearable  :readonly="ro.caigouzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="采购账号" prop="caigouzhanghao">
					<el-input v-model="ruleForm.caigouzhanghao" placeholder="采购账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="采购姓名" prop="caigouxingming">
					<el-input v-model="ruleForm.caigouxingming" placeholder="采购姓名" clearable  :readonly="ro.caigouxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="采购姓名" prop="caigouxingming">
					<el-input v-model="ruleForm.caigouxingming" placeholder="采购姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.touxiang" label="头像" prop="touxiang">
					<file-upload
						tip="点击上传头像"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-else-if="ruleForm.touxiang" label="头像" prop="touxiang">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="电话号码" prop="dianhuahaoma">
					<el-input v-model="ruleForm.dianhuahaoma" placeholder="电话号码" clearable  :readonly="ro.dianhuahaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="电话号码" prop="dianhuahaoma">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				caigouxingming: [
					{ required: true, message: '采购姓名不能为空', trigger: 'blur' },
				],
				mima: [
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='caigouzhanghao'){
							this.ruleForm.caigouzhanghao = obj[o];
							this.ro.caigouzhanghao = true;
							continue;
						}
						if(o=='caigouxingming'){
							this.ruleForm.caigouxingming = obj[o];
							this.ro.caigouxingming = true;
							continue;
						}
						if(o=='mima'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `caigou/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.caigouCrossAddOrUpdateFlag = false;
						 this.parent.search();
