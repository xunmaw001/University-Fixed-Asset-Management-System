	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.jieyongbianhao" label="借用编号" prop="jieyongbianhao">
					<el-input v-model="ruleForm.jieyongbianhao" placeholder="借用编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="领取时间" prop="lingqushijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.lingqushijian" 
						type="datetime"
						:readonly="ro.lingqushijian"
						placeholder="领取时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.lingqushijian" label="领取时间" prop="lingqushijian">
					<el-input v-model="ruleForm.lingqushijian" placeholder="领取时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="借用时间" prop="jieyongshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.jieyongshijian" label="借用时间" prop="jieyongshijian">
