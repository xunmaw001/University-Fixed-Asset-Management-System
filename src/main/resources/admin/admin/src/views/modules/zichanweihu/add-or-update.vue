<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'" label="维护编号" prop="weihubianhao">
					<el-input v-model="ruleForm.weihubianhao" placeholder="维护编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.weihubianhao" label="维护编号" prop="weihubianhao">
					<el-input v-model="ruleForm.weihubianhao" placeholder="维护编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="维护情况" prop="weihuqingkuang">
					<el-input v-model="ruleForm.weihuqingkuang" placeholder="维护情况" clearable  :readonly="ro.weihuqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="维护情况" prop="weihuqingkuang">
					<el-input v-model="ruleForm.weihuqingkuang" placeholder="维护情况" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="维护时间" prop="weihushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.weihushijian" label="维护时间" prop="weihushijian">
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='weihuqingkuang'){
							this.ruleForm.weihuqingkuang = obj[o];
							this.ro.weihuqingkuang = true;
							continue;
						}
						if(o=='shuliang'){
				...
				this.ruleForm.weihuqingkuang='已维护'
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zichanweihu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zichanweihuCrossAddOrUpdateFlag = false;
						 this.parent.search();
