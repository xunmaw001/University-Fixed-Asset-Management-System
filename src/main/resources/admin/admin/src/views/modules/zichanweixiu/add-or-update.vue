	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="维修状态" prop="weixiuzhuangtai">
					<el-input v-model="ruleForm.weixiuzhuangtai" placeholder="维修状态" clearable  :readonly="ro.weixiuzhuangtai"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="维修状态" prop="weixiuzhuangtai">
					<el-input v-model="ruleForm.weixiuzhuangtai" placeholder="维修状态" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="维修时间" prop="weixiushijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.weixiushijian" label="维修时间" prop="weixiushijian">
