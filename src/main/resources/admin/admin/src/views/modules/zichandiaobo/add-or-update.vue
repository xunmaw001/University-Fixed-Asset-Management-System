<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'" label="调拨编号" prop="diaobobianhao">
					<el-input v-model="ruleForm.diaobobianhao" placeholder="调拨编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.diaobobianhao" label="调拨编号" prop="diaobobianhao">
					<el-input v-model="ruleForm.diaobobianhao" placeholder="调拨编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="调拨时间" prop="diaoboshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.diaoboshijian" label="调拨时间" prop="diaoboshijian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="textarea" v-if="type!='info'" label="调拨详情" prop="diaoboxiangqing">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="调拨详情"
					  v-model="ruleForm.diaoboxiangqing" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.diaoboxiangqing" label="调拨详情" prop="diaoboxiangqing">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.diaoboxiangqing}}</span>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='diaobobianhao'){
							this.ruleForm.diaobobianhao = obj[o];
							this.ro.diaobobianhao = true;
							continue;
						}
						...
						if(o=='diaoboxiangqing'){
							this.ruleForm.diaoboxiangqing = obj[o];
							this.ro.diaoboxiangqing = true;
							continue;
						}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zichandiaobo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zichandiaoboCrossAddOrUpdateFlag = false;
						 this.parent.search();
