<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-openeds="[]" :unique-opened="true" :style='{"border":0,"width":"180px","listStyle":"none","margin":"0 15px 15px","position":"relative","background":"#FFF"}' class="el-menu-vertical-demo" default-active="0">
				...
				<!-- <el-menu-item index="0" @click="menuHandler('')">
					<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 8px 0 0","color":"#fff","borderRadius":"50%","textAlign":"center","background":"rgba(176, 176, 176, 0)","width":"30px","fontSize":"18px","lineHeight":"30px","height":"30px"}' class="el-icon-menu el-icon-s-home" />
				...
				<el-submenu index="1">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 8px 0 0","color":"#fff","borderRadius":"50%","textAlign":"center","background":"rgba(176, 176, 176, 0)","width":"30px","fontSize":"18px","lineHeight":"30px","height":"30px"}' class="el-icon-menu el-icon-user-solid" />
				...
				<el-submenu v-for=" (menu,index) in menuList.backMenu" :key="menu.menu" :index="index+2+''">
					<template slot="title">
						<i v-if='true' :style='{"verticalAlign":"middle","margin":"0 8px 0 0","color":"#fff","borderRadius":"50%","textAlign":"center","background":"rgba(176, 176, 176, 0)","width":"30px","fontSize":"18px","lineHeight":"30px","height":"30px"}' class="el-icon-menu" :class="icons[index]" />
	...
	methods: {
		...
		styleChange() {
			this.$nextTick(() => {
				  ...
				  const icon = {"border":"none","width":"180px","margin":"0 ","overflow":"hidden","borderRadius":"20px","display":"none"}
	...
	.menu-preview {
	  .el-scrollbar {
		...
		.el-menu-vertical-demo>.el-menu-item {
				  				  ...
				  				  color: #333;
				  				  white-space: nowrap;
				  				  background-image: url(http://codegen.caihongy.cn/20220723/4d7db0e7023e4771b17f359d29c6bd9c.png);
				  				  position: relative;
				  				  height: 60px;
				  		}
		...
		.el-menu-vertical-demo>.el-menu-item:hover {
						...
						background-size: cover;
						color: rgba(255, 208, 151, 1);
						background-image: url(http://codegen.caihongy.cn/20220723/dc9a0fe58cda44928c5c38d50a71e832.png);
					}
