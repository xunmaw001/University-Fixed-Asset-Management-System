<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","color":"#000","float":"left","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"position":"absolute","right":"20px","top":"8px","fontWeight":"600","display":"flex"}'>
